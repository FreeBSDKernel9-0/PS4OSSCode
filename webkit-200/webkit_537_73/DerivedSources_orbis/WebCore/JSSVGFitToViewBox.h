...
public:
    ...
    {
        JSSVGFitToViewBox* ptr = new (NotNull, JSC::allocateCell<JSSVGFitToViewBox>(globalObject->vm().heap)) JSSVGFitToViewBox(structure, globalObject, impl);
...
public:
    ...
    static JSSVGFitToViewBoxPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSSVGFitToViewBoxPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGFitToViewBoxPrototype>(vm.heap)) JSSVGFitToViewBoxPrototype(vm, globalObject, structure);
...
private:
    JSSVGFitToViewBoxPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
