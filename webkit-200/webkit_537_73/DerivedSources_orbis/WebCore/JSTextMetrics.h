...
JSC::JSValue jsTextMetricsActualBoundingBoxLeft(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsTextMetricsActualBoundingBoxRight(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
