...
public:
    ...
    static JSSpeechSynthesisUtteranceConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSpeechSynthesisUtteranceConstructor* ptr = new (NotNull, JSC::allocateCell<JSSpeechSynthesisUtteranceConstructor>(*exec->heap())) JSSpeechSynthesisUtteranceConstructor(structure, globalObject);
