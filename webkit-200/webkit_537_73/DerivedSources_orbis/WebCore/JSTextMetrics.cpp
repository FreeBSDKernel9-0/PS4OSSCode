...
static const HashTableValue JSTextMetricsTableValues[] =
{
    ...
    { "actualBoundingBoxLeft", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsTextMetricsActualBoundingBoxLeft), (intptr_t)0, NoIntrinsic },
    { "actualBoundingBoxRight", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsTextMetricsActualBoundingBoxRight), (intptr_t)0, NoIntrinsic },
...
static const HashTable JSTextMetricsTable = { 9, 7, JSTextMetricsTableValues, 0 };
...
JSValue jsTextMetricsActualBoundingBoxLeft(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSTextMetrics* castedThis = jsCast<JSTextMetrics*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    TextMetrics* impl = static_cast<TextMetrics*>(castedThis->impl());
    JSValue result = jsNumber(impl->actualBoundingBoxLeft());
    return result;
}


JSValue jsTextMetricsActualBoundingBoxRight(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSTextMetrics* castedThis = jsCast<JSTextMetrics*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    TextMetrics* impl = static_cast<TextMetrics*>(castedThis->impl());
    JSValue result = jsNumber(impl->actualBoundingBoxRight());
    return result;
}
