...
public:
    ...
    {
        JSSVGExternalResourcesRequired* ptr = new (NotNull, JSC::allocateCell<JSSVGExternalResourcesRequired>(globalObject->vm().heap)) JSSVGExternalResourcesRequired(structure, globalObject, impl);
...
public:
    ...
    static JSSVGExternalResourcesRequiredPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSSVGExternalResourcesRequiredPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGExternalResourcesRequiredPrototype>(vm.heap)) JSSVGExternalResourcesRequiredPrototype(vm, globalObject, structure);
...
private:
    JSSVGExternalResourcesRequiredPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
