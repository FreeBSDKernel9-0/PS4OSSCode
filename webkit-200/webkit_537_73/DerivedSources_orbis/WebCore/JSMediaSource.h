...
class JSMediaSource : public JSDOMWrapper {
public:
    ...
    MediaSource* impl() const { return m_impl; }
...
public:
    ...
    static JSMediaSourceConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSMediaSourceConstructor* ptr = new (NotNull, JSC::allocateCell<JSMediaSourceConstructor>(*exec->heap())) JSMediaSourceConstructor(structure, globalObject);
...
JSC::EncodedJSValue JSC_HOST_CALL jsMediaSourcePrototypeFunctionAddEventListener(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsMediaSourcePrototypeFunctionRemoveEventListener(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsMediaSourcePrototypeFunctionDispatchEvent(JSC::ExecState*);
// Attributes
