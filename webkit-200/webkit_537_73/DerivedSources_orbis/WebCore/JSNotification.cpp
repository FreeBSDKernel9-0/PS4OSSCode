...
{
    return getStaticValueSlot<JSNotificationConstructor, JSDOMWrapper>(exec, &JSNotificationConstructorTable, jsCast<JSNotificationConstructor*>(cell), propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSNotificationConstructor, JSDOMWrapper>(exec, &JSNotificationConstructorTable, jsCast<JSNotificationConstructor*>(object), propertyName, descriptor);
}
