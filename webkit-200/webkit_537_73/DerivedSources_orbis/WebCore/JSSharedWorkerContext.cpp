...
{
    return getHashTableForGlobalData(exec->vm(), &JSSharedWorkerContextPrototypeTable);
}
...
{
    return getHashTableForGlobalData(exec->vm(), &JSSharedWorkerContextTable);
}
...
JSSharedWorkerContext::JSSharedWorkerContext(VM& vm, Structure* structure, PassRefPtr<SharedWorkerContext> impl)
