...
void JSSVGPathSegLinetoVerticalAbsConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->vm(), exec->propertyNames().prototype, JSSVGPathSegLinetoVerticalAbsPrototype::self(exec, globalObject), DontDelete | ReadOnly);
...
{
    return JSSVGPathSegLinetoVerticalAbsPrototype::create(exec->vm(), globalObject, JSSVGPathSegLinetoVerticalAbsPrototype::createStructure(exec->vm(), globalObject, JSSVGPathSegPrototype::self(exec, globalObject)));
}
