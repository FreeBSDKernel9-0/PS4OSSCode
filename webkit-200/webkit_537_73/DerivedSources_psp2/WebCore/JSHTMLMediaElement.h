...
#endif
JSC::JSValue jsHTMLMediaElementAudioTracks(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsHTMLMediaElementTextTracks(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsHTMLMediaElementVideoTracks(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
