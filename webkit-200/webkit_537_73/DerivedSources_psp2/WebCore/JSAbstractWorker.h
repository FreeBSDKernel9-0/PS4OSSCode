...
public:
    ...
    {
        JSAbstractWorker* ptr = new (NotNull, JSC::allocateCell<JSAbstractWorker>(globalObject->vm().heap)) JSAbstractWorker(structure, globalObject, impl);
...
public:
    ...
    static JSAbstractWorkerPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSAbstractWorkerPrototype* ptr = new (NotNull, JSC::allocateCell<JSAbstractWorkerPrototype>(vm.heap)) JSAbstractWorkerPrototype(vm, globalObject, structure);
...
private:
    JSAbstractWorkerPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
