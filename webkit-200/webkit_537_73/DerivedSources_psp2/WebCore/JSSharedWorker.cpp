...
{
    return JSSharedWorkerPrototype::create(exec->vm(), globalObject, JSSharedWorkerPrototype::createStructure(exec->vm(), globalObject, JSAbstractWorkerPrototype::self(exec, globalObject)));
}
