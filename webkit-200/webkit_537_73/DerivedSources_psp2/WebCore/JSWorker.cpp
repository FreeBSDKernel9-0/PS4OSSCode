...
{
    return JSWorkerPrototype::create(exec->vm(), globalObject, JSWorkerPrototype::createStructure(exec->vm(), globalObject, JSAbstractWorkerPrototype::self(exec, globalObject)));
}
