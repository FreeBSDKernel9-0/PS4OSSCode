...
public:
    ...
    static JSSpeechSynthesisEventConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSpeechSynthesisEventConstructor* ptr = new (NotNull, JSC::allocateCell<JSSpeechSynthesisEventConstructor>(*exec->heap())) JSSpeechSynthesisEventConstructor(structure, globalObject);
