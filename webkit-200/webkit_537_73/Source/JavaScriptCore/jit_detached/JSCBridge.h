...
namespace JSC {
    ...
    public:
        ...
        public:
            ...
            void * operator new(size_t size)        { __builtin_trap(); return NULL; }
            void * operator new[](size_t, void* p)  { __builtin_trap(); return NULL; }
            void * operator new[](size_t size)      { __builtin_trap(); return NULL; }
...
#undef  CLASSINFO_STUB_ENTRY
    ...
    public:
        ...
        inline JSCBridgeToll *    toll() { assert(m_sharedData); assert(m_sharedData->m_payload.m_toll); return m_sharedData->m_payload.m_toll; }
