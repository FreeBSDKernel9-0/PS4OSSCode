...
namespace JSC {
    ...
    DECLARE_REMOTE_VAR(const double, zero);
    DECLARE_REMOTE_VAR(const double, byteMax);
    DECLARE_REMOTE_VAR(const double, half);
    ...
    namespace Yarr {
    DECLARE_REMOTE_VALUE(const char *, regExp_spacesData);
    DECLARE_REMOTE_VALUE(const char *, regExp_wordcharData);
    }
